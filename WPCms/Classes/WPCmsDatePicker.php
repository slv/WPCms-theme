...
Class WPCmsDatePicker Extends WPCmsField {
  ...
  {
    wp_enqueue_style('jquery.ui.theme', WPCMS_STYLESHEET_DIR . '/WPCms/assets/jquery-ui-datepicker/css/jquery-ui-1.10.2.custom.min.css');
    wp_enqueue_script('jquery.ui.datepicker', WPCMS_STYLESHEET_DIR . '/WPCms/assets/jquery-ui-datepicker/js/jquery-ui-1.10.2.custom.min.js', array('jquery', 'jquery-ui-core'));
  }
