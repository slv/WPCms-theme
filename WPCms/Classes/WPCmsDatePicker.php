...
Class WPCmsDatePicker Extends WPCmsField {
  ...
  public function addActionAdminEnqueueScripts ($hook)
  {
    ...
    wp_enqueue_script('jquery.ui.datepicker', WPCMS_STYLESHEET_URI . '/WPCms/assets/jquery-ui-datepicker/js/jquery-ui-1.10.2.custom.min.js', array('jquery', 'jquery-ui-core'));
  }
